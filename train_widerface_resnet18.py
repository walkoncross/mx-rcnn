...
from rcnn.resnet import resnet_18
...
def main():
    ...
    init_config()
    if "resnet" in args.pretrained:
        sym = resnet_18(num_class=args.num_classes, bn_mom=args.bn_mom, bn_global=True, is_train=True)  # consider background
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prefix', dest='prefix', help='new model prefix',
                        default=os.path.join(os.getcwd(), 'model', 'faster-resnet-18'), type=str)
